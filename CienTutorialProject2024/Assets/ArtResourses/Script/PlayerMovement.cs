...
public class PlayerMovement : MonoBehaviour
{
    ...
    void PlayerRotation()
    {
        if (state != PlayerState.HANGING)
        {
            ...
            {
                Vector3 playerRotate = Vector3.Scale(_camera.transform.forward, new Vector3(1, 0, 1));//ī�޶� �������� ĳ���� ȸ��
                transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(playerRotate), Time.deltaTime * smoothness);
            }
            else
            {
                if (move.magnitude > 0.05f)//�� ���� �ʰ� ������ ��
                {
    ...
    void Hang()
    {
        ...
        //    float distance = Vector3.Distance(hangPosition.position, handPosition.position);//������ ��� ��, �հ��� �Ÿ�
